...
| 3 | ⭐ **`docs/HANDOFF_2026-08-21b.md`** | ⭐ **THE CURRENT ONE.** §1 is the unfinished grid-upgrade work (G130, the next session's first job); §3 lists every parcel figure that moved; §4 the instrument failures |

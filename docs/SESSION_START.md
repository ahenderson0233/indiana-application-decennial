...
| 3 | ⭐ **`docs/HANDOFF_2026-08-22b.md`** | ⭐ **THE CURRENT ONE.** §1 the THREE things the previous handoff got wrong and what replaced them; §2 what moved; §3 five findings; §4 my own instrument failures; §5 the `energy` sweep and the 1,215 unaskable tables; §6 what is left on the SI signals — **two clips, not sixteen** |
| 3w | `docs/HANDOFF_2026-08-22.md` | **HISTORY.** Right about the grid batch and G152's shape. ⛔ WRONG on three load-bearing recommendations — D14/D16 as the *cheapest wins*, IBTR *first*, and the rezoning layer's dates *1990–2008*. Superseded 2026-08-22b. |

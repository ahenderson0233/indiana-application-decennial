...
**311 of 371 registered objects reach a surface.** The other 60 are listed below, each with a reason. An object with no reason FAILS `audit_unwired_classification.py`, which is what keeps this list closed.
